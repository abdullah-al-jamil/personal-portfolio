...
const Hero = () => {
  return (
    <div className="relative min-h-screen bg-[radial-gradient(circle_476px_at_54.8%_51.5%,rgba(168,229,253,1)_0%,rgba(244,244,254,1)_42.3%,rgba(244,244,254,1)_100.2%)] flex items-center justify-center overflow-hidden 
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">Hi, I&apos;m{" "}
                ...
                <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                    <Button size="lg" asChild className='w-fit mx-auto sm:mx-0'>
                        <a href="#contact"><FolderOpen className='w-5 h-5 mr-2' />
                            View Projects</a>
                    </Button>
                    <Button size="lg" asChild className='w-fit mx-auto sm:mx-0'>
                        <a href="#_">
