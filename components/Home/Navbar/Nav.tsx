    ...
    <div className={`transition-all duration-200 h-[12vh] z-100 fixed w-full ${navBg ? "dark:bg-gray-800 bg-white shadow-md" : "fixed"}`}>
      <div className='flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto'>
        ...
        <div className='flex items-center space-x-4'>
          <a href="/Resume_Abdullah_Al_Jamil.pdf" download className='box-border relative z-20 inline-flex items-center justify-center w-auto px-6 sm:px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300
